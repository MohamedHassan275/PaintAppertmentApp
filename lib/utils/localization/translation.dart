...
class MyTranslation extends Translations{
  ...
  Map<String, Map<String, String>> get keys =>{
    "ar" : {
      ...
      "title_boarding1" : "شطب شقتك تطبيق متنوع يضم كافة احتياجاتك مثل خدمات النظافة والسباكة والكهرباء وغيرها",
      "title_boarding2" : "شطب شقتك من خلاله تعرف سعر تشطيب شقتك او فيلتك الخاصة بكل سهولة وكمان عندنا هتشوف صور التصميمات الحديثة ",
