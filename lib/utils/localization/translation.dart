...
class MyTranslation extends Translations{
  ...
  Map<String, Map<String, String>> get keys =>{
    "ar" : {
      ...
      "title_boarding1" : "شطب شقتك تطبيق متنوع يضم كافة احتياجاتك مثل خدامات النظافة والسباكة والكهرباء وغيرها",
      "title_boarding2" : "دلوقتي بضغطة زر تقدر تطلب خدامات كتير من غير ما تتعب نفسك علشان عندنا افضل الفنين في كل الخدامات ",
      "title_boarding3" : "شطب شقتك من خلاله تعرف سعر تطشيب شقتك او فيلتك الخاصة بك بسهولة وكمان عندنا ممكن تشوف صور التصميمات الحديثة ",
      "title_boarding4" : "بأمكان الفنين واصحاب المهن ومقدمي الخدمات الاشتراك في التطبيق كمزود خدمة من خلاص الاشتراك الخاص بالفنيين ",
      ...
      "login" : "تسجيل دخول",
      "register_technical" : "تسحيل اشتراك ك فني",
      ...
      "order_details2" : "تفاصيل الطلب ",
      "request_type" : "اسم الخدمة : ",
      "chose_service" : "اختر الخدمة",
