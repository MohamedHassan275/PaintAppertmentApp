...
class MyTranslation extends Translations{
  ...
  Map<String, Map<String, String>> get keys =>{
    "ar" : {
      ...
      "title_boarding2" : "دلوقتي بضغطة زر تقدر تطلب خدامات كتير من غير ما تتعب نفسك وتدور علشان عندنا افضل الفنين في كل الخدامات ",
      "title_boarding3" : "شطب شقتك من خلاله تعرف سعر تطشيب شقتك او فيلتك الخاصة بكل سهولة وكمان عندنا هتشوف صور التصميمات الحديثة ",
